              ...
              <div style={{display:'flex', flexDirection:'column'}}>
                {pinnedItems.map((p, idx) => (
                  <div key={p.id} style={{
                    ...
                    {p.video_url && (
                      <a href={p.video_url} target="_blank" rel="noopener noreferrer" title="Apri Link" style={{fontSize:'1.3em', textDecoration:'none', opacity: 0.9}}>🔗</a>
                    )}
                  </div>
                ))}
              </div>
